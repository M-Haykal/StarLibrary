...
.content-wrapper {
    min-height: calc(100vh - 56px); /* 56px adalah tinggi navbar Anda */
    margin-bottom: 40px; /* Sesuaikan dengan tinggi footer Anda */
}
...
<body>
    <nav class="navbar navbar-expand navbar-dark sticky-top px-4 py-0">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarSupportedContent" style="margin-left: auto; margin-right: auto;">
    ...
    <script src="https://code.jquery.com/jquery-3.4.1.min.js"></script>
        ...
        <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.bundle.min.js" integrity="sha384-szQnJiY/G2en6BtFCCgPzrDmV4qrRQgOjTwgLfgp5r9gX0u6PUiEZKZ/kZQ5Cx7X" crossorigin="anonymous"></script>
